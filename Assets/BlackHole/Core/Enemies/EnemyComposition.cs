...
{
    // 판 조립이 받는 적 종류 하나의 판 구성 값(BATTLE_COMPOSITION_PLAN 4.2): 질량 단계, 황금 비율, 황금 배율.
    ...
    public readonly struct EnemyComposition
    {
        ...
        public EnemyComposition(int massLevel, float goldenRatio, float goldenMultiplier)
        {
            if (massLevel < 0)
        ...
        // 노드 보정이 없을 때: 질량 단계 0, 황금 비율 0, 황금 배율은 종류의 기본값.
