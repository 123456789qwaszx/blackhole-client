...
기준: 처음 점검은 dev `85e34bc`(2026-09-24, 코드 열람). M4~M6 완료 후 "단계" 열에 반영 상태를 적었다.
...
| Core/Enemies/EnemyDefinition.cs | HP·속도·Size만, Size는 반지름 보상 정의는 M4, 실행 보상(EnemyReward, 출현 때 확정)은 M6 완료. 사망 효과는 M7 |
...
| ContentData/Loader/Invariants/GameContent | Session/HQ/Enemy/Spawn/Skill 정의 보상은 M4, 성장·공급은 M5, 구매 노드는 M6 완료. 사망 효과는 M7 |
