...
dev의 M0~M7이 완료됐습니다. 다음은 M8(변화 실험과 팀 분배 자료)이며, 착수 전에 정할 것을 확인하는 단계입니다.
...
M7 기준 계약 63개가 통과합니다. CoreSmoke는 Unity 호스트·입력·렌더링 검증을 대체하지 않습니다.
